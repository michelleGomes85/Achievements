...
[**Nivelamento – Programa Hackers do Bem: Formação em Cibersegurança**](https://github.com/michelleGomes85/Achievements/blob/main/Certificado_-_Nivelamento.pdf)  
- **Instituição**: SENAI SP em parceria com o Programa Hackers do Bem  
- **Período de realização**: 22/01/2024 – 06/10/2025  
...
- **Descrição**: A formação foi dividida em três módulos principais:  
  1. **Primeiros passos no mundo da Inteligência Artificial**: Introdução ao conceito de IA, suas origens e desenvolvimento ao longo do tempo.  
  2. **Como e onde a IA está presente em nosso dia a dia**: Estudo prático e teórico sobre as aplicações da IA em diversas áreas como saúde, finanças e tecnologia.  
  3. **Os pilares da Inteligência Artificial**: Exploração dos fundamentos teóricos da IA, incluindo aprendizado de máquina, redes neurais e processamento de linguagem natural.  
